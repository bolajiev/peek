...
export const AVAILABLE_MODELS: ModelInfo[] = [
  {
    ...
    badge: 'Default',
    badgeColor: '#FDC803',
    description: 'Default general-purpose AI. Fast responses, low RAM. Best for Quick Chat, Scribe, Voice, and Deep.',
    size: '1.1GB',
  ...
  },
  {
    ...
    badge: 'Health Focus',
    badgeColor: '#EF4444',
    description: 'Optional medical AI. Deep health and nutrition knowledge. Switch to this for health-specific queries.',
    size: '2.4GB',
